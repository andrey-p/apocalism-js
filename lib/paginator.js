...
exports.paginate = function (args, callback) {
  ...
  if (!args.templateName || !args.sectionName || !args.content) {
    callback("args needs to specify templateName, sectionName and content");
    return;
  }
  ...
  async.whilst(
    ...
    function (callback) {
      ...
      blankPage = template.getBlankPage(args.templateName, { pageNumber: currentPage, classes: classes });
...
exports.createStandalonePage = function (args, callback) {
  ...
  blankPage = template.getBlankPage(args.templateName, {
    classes: classes
  });
