...
exports.init = function (options, callback) {
  ...
  // if the output is PDF, we need a complete path to the fonts in the apocalism.js folder
  fontUrlBase = options.template === "pdf" ? "\"" + pathToTemplateDir + "/fonts\"" : "\"fonts\"";
  ...
  async.waterfall([
    ...
    function (callback) {
      fs.readFile(pathToTemplateDir + "/style.scss", callback);
    },
...
exports.saveStyleAssetsToDir = function (targetDir, callback) {
  ...
  async.parallel([
    function (callback) {
      fs.copy(pathToTemplateDir + "/fonts", targetDir + "/fonts", callback);
    },
    function (callback) {
